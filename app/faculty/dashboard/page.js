  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-1/5 bg-yellow-400 flex flex-col">
        ...
        <div className="mt-4 px-4 text-black space-y-4 font-medium">
          <Link to="/dashboard" className="hover:underline hover:text-blue-700">DASHBOARD</Link>
          <Link to="/courses" className="hover:underline hover:text-blue-700">COURSES</Link>
          <Link to="/instructors" className="hover:underline hover:text-blue-700">INSTRUCTORS</Link>
          <Link to="/students" className="hover:underline hover:text-blue-700">STUDENT RECORDS</Link>
          <Link to="/fees" className="hover:underline hover:text-blue-700">FEES</Link>
          <Link to="/announcements" className="hover:underline hover:text-blue-700">ANNOUNCEMENTS</Link>
        </div>
      </div>
